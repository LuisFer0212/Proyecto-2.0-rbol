...
namespace Proyecto_2_Arbol
{
    public class FamiliaForm : Form
    {
        ...
        private void BtnGuardar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Ingrese una edad válida (0-130).", "Edad inválida", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            {
                MessageBox.Show("La latitud debe estar entre -90 y 90.", "Latitud inválida", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            {
                MessageBox.Show("La longitud debe estar entre -180 y 180.", "Longitud inválida", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            {
                MessageBox.Show("Debe seleccionar una foto.", "Foto faltante", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
